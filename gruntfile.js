            ...
            dev: {
                ...
                files: {
                    './js/scripts.min.js': [
                        ...
                        '_/js/skip-link-focus-fix.js', // bootpass DEPS
                        '_/js/jquery.easing.1.3.umd.js', // jquery ease
                        '_/js/wow.js', // WOW
                        //'_/js/customizer.js', // bootpass DEPS
                        //'_/js/navigation.js', // bootpass DEPS
                    ]
                }
            },
            prod: {
